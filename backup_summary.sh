...
deleted=$(rm_old_files2 $dir_trabalho $dir_backup $checking)           # remove os ficheiros/diretórios que já não estou no diretório de trabalho

echo "While backuping "$dir_trabalho": $deleted deleted"
